...
import type { Question, CVData, AnswerResult } from '../../types/interview';
...
export const InterviewStep = ({ questions, cvData, jobDescription, onComplete }: Props) => {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 p-6 space-y-4">
        <span className="px-2.5 py-1 bg-primary-50 dark:bg-primary-950 text-primary-600 dark:text-primary-400 text-[11px] font-bold rounded-full border border-primary-100 dark:border-primary-900 uppercase tracking-widest">
        ...
        {showHint && (
          <div className="px-4 py-3 bg-gray-50 dark:bg-gray-800 rounded-xl text-sm text-gray-500 dark:text-gray-400 border border-gray-100 dark:border-gray-700">
      ...
      <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 p-6 space-y-4">
        ...
        <div className={`min-h-[120px] p-4 rounded-xl border transition-all ${
          isListening
            ? 'border-danger-400 bg-danger-50/30 dark:bg-danger-950/20'
            ...
            <div className="flex items-center gap-2 text-danger-500">
              <div className="flex gap-1 items-end h-5">
                {[0, 1, 2].map(i => (
                  <div
                    key={i}
                    className="w-1 bg-danger-500 rounded-full animate-pulse"
          ...
          {transcript
            ...
            : !isListening && <p className="text-sm text-gray-400">Press mic and start speaking...</p>
          }
        </div>
        ...
        <div className="flex items-center gap-3">
          {!isListening ? (
            <button
              ...
              className="flex items-center gap-2 px-5 py-2.5 bg-danger-500 hover:bg-danger-600 text-white rounded-xl text-sm font-semibold transition-all"
            >
            ...
            <button
              ...
              className="flex items-center gap-2 px-5 py-2.5 bg-gray-800 dark:bg-gray-700 text-white rounded-xl text-sm font-semibold transition-all"
            >
